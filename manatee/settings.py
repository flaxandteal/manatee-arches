...
SECRET_KEY = 's%e0b$qew$cso(kqrg^ves-!d3i!6#@6#uk3$0z&f22lxa9l20'
...
ELASTICSEARCH_PREFIX = 'manatee'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'manatee.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'manatee.wsgi.application'
